...
<?php 
    if(isset($_GET['kirim'])){
        $_GET['kirim'] = "";
            ...
            $total_dana_kebutuhan = ((float)$angka1 * 0.5);
            $total_dana_keinginan = ((float)$angka1 * 0.3);
            $total_dana_investasi = ((float)$angka1 * 0.2);
?>
